...
class CrearIncidenciaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'sub-tipo' => 'in:EDUCANTABRIA,GOOGLE CLASSROOM,DOMINIO,YEDRA,ALTAVOCES,PC,MONITOR,PROYECTOR,PANTALLA,PANTALLA INTERACTIVA,PORTATIL,IMPRESORA,IESMIGUELHERRERO,WIECAN,INSTALACION,ACTUALIZACION',
            'sub-sub-tipo' => 'in:RATON,ORDENADOR,TECLADO,PROPORCIONADO POR CONSEJERIA,DE AULA,DE PUESTO',
