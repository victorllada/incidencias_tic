    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="background-color: #0e97e9; font-family: Arial, Helvetica, sans-serif">Duración</th>
            </tr>
        </thead>
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="9" style="font-family: Arial, Helvetica, sans-serif">No hay incidencias</td>
                </tr>
            @endforelse
        </tbody>
    </table>
